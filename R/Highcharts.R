...
# @include getLayer.R
#' @export Highcharts
Highcharts <- setRefClass("Highcharts", contains = "highchartsUtils", methods = list(
    initialize = function() {
    ...
    getPayload = function(chartId){
        ...
        list(chartParams = toJSON2(params, digits = 13), chartId = chartId, addFunctionJS = addFunctionJS, htmlheader = htmlheader)
    },
